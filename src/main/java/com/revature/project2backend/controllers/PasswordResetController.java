...
public class PasswordResetController {
    ...
    @PutMapping
    ResponseEntity<JsonResponse> changePassword(@RequestBody ChangePasswordBody body) throws InvalidValueException {
        ...
        passwordResetService.changePasswordAndDeleteToken(user);
