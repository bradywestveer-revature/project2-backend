...
public class PasswordResetService {
    ...
    public PasswordReset createOrUpdateToken(User user){
        ...
        System.out.println("createOrUpdateToken(...): passwordReset(before)"+passwordReset);
        ...
        System.out.println("createOrUpdateToken(...): passwordReset(after)"+passwordReset2);
    ...
    public void changePasswordAndDeleteToken(User user) {
